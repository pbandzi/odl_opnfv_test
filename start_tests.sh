...
example:
    ODL_IP=oscontro1 ODL_PORT=8080 ./$(basename "$0")"
...
set -x
ODL_IP=${ODL_IP:-'1.80.1.95'}
ODL_PORT=${ODL_PORT:-8081}
PASS=${PASS:-'octopus'}
NEUTRON_IP=${NEUTRON_IP:-1.80.1.95}
set +x
...
# add custom tests to suite, if in the future there are more custom tests needed this part will be reworked
